...
export default function About () {
    ...
    return (
        <>
            <div className="grid md:grid-cols-2 pt-20 gap-10 justify-center divide-x divide-gray-300">
                <div className='flex flex-col justify-center text-center'>
                    ...
                    <img src={imagesection1} alt="Img section" className="rounded-2xl lg:w-80 lg:mx-20 xl:w-100 xl:mx-70"/>
                </div>
                <div>
                    ...
                    <video autoPlay muted loop playsInline className="rounded-2xl xl:md:w-200 xl:mx-20">
